...
| 참조 | 요구 사양 |
|---|---|
| **U1** 컨트롤러 | **TI LM5156** (선정 근거·대안: [`controller-selection.md`](controller-selection.md)). BIAS ≤ 60 V로 Vin 직결, 100 kHz, **CS 100 mV** → Rcs 손실 0.04 W, 슬로프보상·LEB 내장 |
| **Q1** MOSFET | **150 V** N-ch, Rds(on) ≤ 75 mΩ @Vgs 10 V, Id ≥ 5 A, Qg ≤ 15 nC, DPAK/SOT-223 |
| **Rcs** | **42 mΩ / 0.5 W** (LM5156 100 mV 기준), 저인덕턴스·켈빈 연결 필수. 손실 0.04 W |
| **R_st** 기동저항 | **불요** — LM5156 BIAS를 Vin에 직결. Naux는 VCC 외부급전(효율)용 선택 |
...
| Q1 (도통 + 스위칭) | 0.32 | |
| 동기벅 5.0 V | 0.22 | |
| 전류센스 Rcs | 0.04 | LM5156 CS 100 mV 기준 |
| D2 / 컨트롤러 | 0.12 | |
| **집계** | **3.48** | = 입력 11.48 − 출력 8.00 ✔ |
...
| A5 | **LM5156 최대듀티 @100 kHz** | 0.535 이상인지 데이터시트 확인 (스니펫 미확인) |
