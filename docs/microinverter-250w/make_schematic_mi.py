...
lines(X_PV, 326, ["Voc(STC) 37.6 V  (상한 41.4 V)", "저온 -25 C : 43.6 V",
                  "-> 입력 절대최대 48 V"], 9, G)
...
block(56, 542, 356, 92, "2w 디커플링 663 mJ  -  60 V 27,000 uF x 5 실장",
      ["= 135,000 uF  (설계 최소요구 7,129 uF 의 18.9 배)",
       "2w 리플 159 mVpp (0.52 %),  MPPT 이용률 99.997 %",
       "리플전류 개당 2.42 Arms,  자기발열 &lt; 1 K",
       "저장에너지 128 J -> 방전회로 필수,  입력 절대최대 48 V"], V, "#faf5ff")
...
for i, (a, b) in enumerate((("1. MPPT (P&amp;O + 전역스캔)", "반주기 이동평균 Vpv 사용"),
                            ("2. 진폭루프 kp 1.33 / ki 22.8", "~8 Hz (135,000 uF 기준)"),
