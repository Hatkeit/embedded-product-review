...
lines(X_PV, 326, ["Voc(STC) 37.6 V", "저온 -25 C : 43.6 V", "-> 입력정격 50 V 이내"], 9, G)
...
block(56, 548, 340, 84, "2w(120 Hz) 전력 디커플링  663 mJ",
      ["[A] 수동 7129 uF/50 V 전해 (1500 uF x5, 5.8 Arms)",
       "      MPPT 이용률 98.9 %,  수명 5.6 년 @60 C",
       "[B] 능동 11 uF/450 V 필름 + 양방향 벅부스트 (79.6 W)",
       "      이용률 99.9 %,  수명 25 년+,  효율 -1.3 %p"], V, "#faf5ff")
